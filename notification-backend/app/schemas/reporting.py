...
class ReportingFunctionUrls(BaseModel):
    ...
    by Reporting 02, Reporting 03, Reporting 04,
    Reporting 1.5 and Reporting 01.
    """
    ...
    # Reporting 01
    #
    # Dynamically resolved by backend from:
    #   Function App Name + Function Name
    #
    # These values are passed to Reporting 01 ARM as:
    #   cmdbReportingIpFunctionUrl
    #   qualysLaunchReportFunctionUrl
    # --------------------------------------------------------

    cmdb_reporting_ip_function_url: Optional[str] = None
    qualys_launch_report_function_url: Optional[str] = None
...
class ReportingLogicAppUrls(BaseModel):
    ...
    #
    # Dynamically retrieved from LA-reporting-1.5.
    #
    # This callback URL is passed to Reporting 01 as:
...
class ReportingDeploymentRequest(BaseModel):
    ...
    Reporting 1.5 dynamically provides its callback URL
    to Reporting 01 as reportingPart2LogicAppUrl.

    Reporting 01 dynamically resolves:

        - cmdbReportingIpFunctionUrl
        - qualysLaunchReportFunctionUrl

    The user provides Function App name + Function name
    for each Reporting 01 function.
    """
    ...
    reporting_01_logic_app_name: str = "LA-reporting-01"
    ...
    # ========================================================
    # Reporting 01 - CMDB Reporting IP Function
    #
    # User provides:
    #     Function App Name
    #     Function Name
    ...
    cmdb_reporting_ip_function_app_name: str
    cmdb_reporting_ip_function_name: str

    # ========================================================
    # Reporting 01 - Qualys Launch Report Function
    #
    # User provides:
    #     Function App Name
    #     Function Name
...
class ReportingDeploymentResponse(BaseModel):
    ...
    reporting_01_logic_app_name: Optional[str] = None
    ...
    # ========================================================
    # Reporting 01 deployment
    # ========================================================

    reporting_01_deployment_name: Optional[str] = None
    reporting_01_provisioning_state: Optional[str] = None
    ...
    # Dynamically retrieved from LA-reporting-1.5.
    #
    # Passed to Reporting 01 as reportingPart2LogicAppUrl.
    # ========================================================
